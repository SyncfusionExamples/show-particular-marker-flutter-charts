...
class MarkerAtSinglePoint extends StatefulWidget {
  ...
  @override
  _MarkerAtSinglePointState createState() => _MarkerAtSinglePointState();
}

/// State class of the default area chart.
class _MarkerAtSinglePointState extends State<MarkerAtSinglePoint> {
  _MarkerAtSinglePointState();
